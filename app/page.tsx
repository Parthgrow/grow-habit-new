...
import { isUserPro } from "@/lib/helpers/isUserPro";
                ...
                <Card className="w-full max-w-md">
                    <CardHeader>
                        <CardTitle className="text-center">
                            Welcome to GrowHabit
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <p className="text-center text-gray-600">
                            Please sign in to access your habit tracking
                            dashboard.
                        </p>
                ...
                <div className="max-w-2xl mx-auto">
                    <Card>
                        <CardHeader>
                            ...
                            <p className="text-center text-gray-600">
                                Let's start your habit tracking journey by
                                defining your first habit
                            </p>
                        </CardHeader>
                        <CardContent>
                            <form
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500 mt-1">
                                        ...
                                        achieve and how you'll measure success.
                                    </p>
                                </div>
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card className="hover:shadow-lg transition-shadow">
                        ...
                        <CardContent>
                            <p className="text-gray-600 mb-4">
                                Record your daily habit progress and reflections
                                to track your growth journey.
                            </p>
                    ...
                    <Card className="hover:shadow-lg transition-shadow">
                        ...
                        <CardContent>
                            <p className="text-gray-600 mb-4">
                                View your progress over time and see how your
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-gray-600">
                                    You have successfully created a habit! Your
                                    habit ID is stored and ready for tracking.
                                </p>
                            </div>
                        </div>
                    </CardContent>
